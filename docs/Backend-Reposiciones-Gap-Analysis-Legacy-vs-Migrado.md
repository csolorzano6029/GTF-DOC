...
| GET /replenishments/billing-concepts                | AdminReposicionesUtils.construyeEstructuraConceptos                                                                                  | Implementado    | Parcial     | Se expone endpoint por area/trx/tipo documento y agrupacion por categoria; mantener validacion funcional de datos en PRE                                                         | Completar pruebas integrales de datos contra tablas legacy y ajuste fino de mapeos de categoria/tipo concepto si aplica                                                   |
