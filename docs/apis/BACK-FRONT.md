...
| Administracion de Reposiciones | Reposiciones > Administracion | Acciones de solicitud   | Imprimir                     | GET /replenishment-management/{id}/print                                        | Pendiente P1                            | Generar comprobante                                                                             |
