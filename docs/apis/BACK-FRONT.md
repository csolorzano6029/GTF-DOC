...
| Administracion de Reposiciones | Reposiciones > Administracion | Flujo de envio          | Enviar reposicion            | POST /replenishment-management/{id}/send                                        | Implementado (P0 - corte 6)             | Cambiar estado y ejecutar validaciones de envio                                                 |
