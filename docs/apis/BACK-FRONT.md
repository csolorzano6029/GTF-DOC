...
| POST /replenishments/filter                | Parcial      | Forzar filtro por area de trabajo del usuario, mejorar soporte de filtros de fecha/estado como en legacy y mantener orden ascendente por `createdDate` (antiguos primero) |
